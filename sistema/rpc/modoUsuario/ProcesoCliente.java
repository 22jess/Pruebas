...
public class ProcesoCliente extends Proceso{
	...
	public ProcesoCliente(Escribano esc){
		super(esc);
		lib=new LibreriaServidor(esc);  //primero debe funcionar el run() con esta libreria
		//lib=new LibreriaCliente(esc);  //luego con esta comentando la anterior, para lo remoto
		start();
	}
