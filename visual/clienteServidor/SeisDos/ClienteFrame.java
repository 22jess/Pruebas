...
import sistemaDistribuido.sistema.clienteServidor.modoUsuario.SeisDos.ProcesoCliente;
...
public class ClienteFrame extends ProcesoFrame{
	...
	public static ProcesoCliente proc;//mio era private
	public static Choice codigosOperacion;
	public static TextField campoMensaje;
	...
	public Panel construirPanelSolicitud(){
		...
		campoMensaje.setText("valor por defecto");//mio
	...
	class ManejadorSolicitud implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			...
			if (com.equals("Solicitar")){
				botonSolicitud.setEnabled(true);//mio era false
